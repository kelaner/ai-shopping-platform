  ...
  return (
    <>
      <Box sx={{ p: 3, width: 1 }}>
        ...
        <div>
          <Box sx={{ mb: 1.5, typography: 'subtitle2', opacity: 0.48 }}>当前余额</Box>
        ...
        <Box sx={{ gap: 5, display: 'flex', typography: 'subtitle1' }}>
          <div>
            <Box sx={{ mb: 1, opacity: 0.48, typography: 'caption' }}>持卡人</Box>
            <Box component="span">邱明杰</Box>
          </div>
          <div>
            <Box sx={{ mb: 1, opacity: 0.48, typography: 'caption' }}>有效期</Box>
